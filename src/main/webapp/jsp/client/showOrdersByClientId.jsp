...
<head>
    ...
    <title><fmt:message key="showById.title"/></title>
</head>
<body>
<c:set var="pagePath" value="/jsp/admin/showOrdersByClientId.jsp" scope="session"/>
<%@ include file="/jsp/static/header.jsp" %>
<div class=" container-fluid wrapper">
    <div class="container pt-3">
        <form method="POST" action="${pageContext.request.contextPath}/controller">
            <input type="hidden" name="command" value="show_orders_by_client_id">
            <input type="submit" class="btn btn-primary" value="<fmt:message key="showById.submit"/>"/>
