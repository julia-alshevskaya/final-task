    ...
    <div class="container pt-3">
        <form name="changePasswordForm" method="POST" action=${pageContext.request.contextPath}/controller>
            ...
            <div class="form-group">
                ...
                <label for="myPassword1"><fmt:message key="change.confirmedPassword"/> </label>
                <input type="password" class="form-control" id="myPassword1" name="confirmedPassword" value="" required
                       maxlength="45" placeholder="<fmt:message key="change.confirmedPassword" />"/>
                <br/>
            ...
            <input type="submit" class="btn btn-primary" value="<fmt:message key="change.submit"/>"/>
        </form>
    </div>
</div>
